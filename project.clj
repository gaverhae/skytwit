(defproject skytwit "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs"]
                ...
                ;; :figwheel {:on-jsload "skytwit.core/on-figwheel-reload"}

                :compiler {:main skytwit.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/skytwit.js"
